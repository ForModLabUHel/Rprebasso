...
pCROB[,8] <- c(0.0552574805543716,146.1815811,59.47661807,0.293587959,0.989521945,
               ...
               0.031652341,59.47661807,0,0.818727858,0,1.1,1.091,1,2.5,0.8) #Populus is based on a small dataset
...
pCROB[,9] <- c(0.204117167,183.1185505,26.02424445,0.222587319,1.004187457,0.404366253,
               ...
               -3.324,0.135,-0.03,0.058115759,40.0468376,2.968459454,1.189177125,0.1149,1.1508,1.091,1,2.5,0.8) # Eucalyptus grandis x Eucalyptus urophylla
...
pCROB[,10] <- c(0.10526535,193.6178231,20.35997692,0.252108283,8.899772817,1.7002118,
                ...
                -2.948,0.059,-0.03,0.044022402,20.02536,0,1.085732672,4.1263,0.9428,0.912,1,2.5,0.8) # Picea abies in Germany
