###default parameters
speciesNam <- c("pisy","piab","beal","fasy","pipi","eugl","rops",'popu','eugrur')
pCROB <- matrix(NA,43,9,dimnames = list(NULL,speciesNam))
...
pCROB[,1] <- c(0.22406007,195.16571750,20.00788979,0.25003240,3.90739583,0.90777990,
               ...
               -0.03000000,0.07000000,20.00788979,0.00000000,1,2.7801,0.9395,1.191)
...
pCROB[,2] <- c(1.585611e-01,1.833353e+02,2.002536e+01,2.503559e-01,9.728822e+00,1.764810e+00,
               ...
               -3.000000e-02,8.000000e-02,2.002536e+01,0.000000e+00,1,4.1263,0.9428,0.912)
...
<<<<<<< HEAD
               -0.03000000,0.01500000,40.56651551,0.00000000,1,0,1.1,1.091)
pCROB[,4] <- c(0.05,350,90,0.33,0.8,2,0.3,0.3,0.3,0.0303,1.8,0.2,0.3,0.3,94.5,
               ...
               0,1,0,1.1,1.091)
=======
               -0.03000000,0.01500000,40.56651551,0.00000000,1,0,1.1)
# pCROB[,4] <- c(0.05,350,90,0.33,0.8,2,0.3,0.3,0.3,0.0303,1.8,0.2,0.3,0.3,94.5,
#                0.01,750,0.43,1,0,0.8,1,1.2,1.45,1.8,1,2,1,1.4,1250,0,36.11545071,
#                0.021412229,0.000639975,-2.948,0.059,-0.03,0.076070141,20.00788979,
#                0,1,0,1.1)
pCROB[,4] <- c(0.051373436,237.3752612,70.02066135,0.260359518,0.995872355,2.440734706,
               ...
               -2.948,0.059,-0.03,0.035899753,20.00788979,0,0.962722532,0,1.1)
>>>>>>> ae70d4c9c0dfaba3340c170efd45e50c4dd96f94
pCROB[,5] <- c(0.171957818,209.0229816,23.71281362,0.266767788,3.737717029,
               ...
               0.055,-0.03,0.070339277,40.56651551,0,1,0,1.1,1.091)
pCROB[,6] <- c(0.249890074,206.5401424,25.88562561,0.277189578,1.961241368,
               ...
               -3.324,0.135,-0.03,0.0322303,40.96937266,2.987999562,1.195552315,0.1149,1.1508,1.091)
pCROB[,7] <- c(0.24661449,257.6439127,45.75561945,0.287913095,0.902917082,
               ...
               -3.324,0.135,-0.03,0.011098704,45.75561945,0,0.958581963,0,1.1,1.091)
pCROB[,8] <- c(0.0552574805543716,146.1815811,59.47661807,0.293587959,0.989521945,
                  ...
                  0.031652341,59.47661807,0,0.818727858,0,1.1,1.091) #Populus is based on a small dataset
...
pCROB[,9] <- c(0.204117167,183.1185505,26.02424445,0.222587319,1.004187457,0.404366253,
               ...
               -3.324,0.135,-0.03,0.058115759,40.0468376,2.968459454,1.189177125,0.1149,1.1508) # Eucalyptus grandis x Eucalyptus urophylla
...
parsAWEN <- matrix(NA,12,9,dimnames = list(NULL,speciesNam))
...
pHcM <- matrix(NA,7,9,dimnames = list(NULL,speciesNam))
...
litterSizeDef <- matrix(0.,3,9,dimnames = list(NULL,speciesNam))
litterSizeDef[1,] <- c(10,10,5,10,10,7,7,7,7)
litterSizeDef[2,] <- 2
