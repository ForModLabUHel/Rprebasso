...
parNames_pCROB <- c("cR","rhow","sla","k","vf","vr","c","mf","mr","mw",
  ...
  "thetaMax","H0max","gamma","kH","decayVp1","decayVp2","decayVp3","ksi","sla0","tsla","NUptakeSwitch","aHdom","bHdom","decayVp4",
  "fAa","fAb","fAc","minDdeadWood","minPerDeadWood",
  "int_kRein(siteType)","slope_kRein(siteType)",
  "int_cR(siteType)","slope_cR(siteType)",
  "nf_p1","nf_p2","nf_p3","nr0","nw0","ff0","fr0","fw0","kN0","Umax_a","Umax_b") ###Nitrogen parameters
pCROB_prior <- matrix(NA,length(parNames_pCROB),length(speciesNam),dimnames = list(NULL,speciesNam))
rownames(pCROB_prior) <-  parNames_pCROB

pCROB_prior[,1] <- c(0.22406007,195.16571750,20.00788979,0.25003240,3.90739583,0.90777990,
               ...
               9.999,.66,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942)
pCROB_prior[,2] <- c(1.585611e-01,1.833353e+02,2.002536e+01,2.503559e-01,9.728822e+00,1.764810e+00,
               ...
               9.999,.60,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942)
pCROB_prior[,3] <- c(0.17815383,216.13110400, 40.56651551,0.31592870,0.96149996,1.43787917,
               ...
               9.999,.46,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942)
pCROB_prior[,4] <- c(0.051373436,237.3752612,70.02066135,0.260359518,0.995872355,2.440734706,
               ...
               -2.948,0.059,-0.03,0.035899753,20.00788979,0,1,0,1.1,1.091,1,2.5,0.8,
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942)
pCROB_prior[,5] <- c(0.171957818,209.0229816,23.71281362,0.266767788,3.737717029,
               ...
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942)
pCROB_prior[,6] <- c(0.249890074,206.5401424,25.88562561,0.277189578,1.961241368,
               ...
               -3.324,0.135,-0.03,0.0322303,40.96937266,2.987999562,1,0.1149,1.1508,1.091,1,2.5,0.8,
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942)
pCROB_prior[,7] <- c(0.24661449,257.6439127,45.75561945,0.287913095,0.902917082,
               ...
               -3.324,0.135,-0.03,0.011098704,45.75561945,0,1,0,1.1,1.091,1,2.5,0.8,
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942)
pCROB_prior[,8] <- c(0.0552574805543716,146.1815811,59.47661807,0.293587959,0.989521945,
               ...
               0.031652341,59.47661807,0,1,0,1.1,1.091,1,2.5,0.8,
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942) #Populus is based on a small dataset

pCROB_prior[,9] <- c(0.204117167,183.1185505,26.02424445,0.222587319,1.004187457,0.404366253,
               ...
               -3.324,0.135,-0.03,0.058115759,40.0468376,2.968459454,1,0.1149,1.1508,1.091,1,2.5,0.8,
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942) # Eucalyptus grandis x Eucalyptus urophylla

pCROB_prior[,10] <- c(0.10526535,193.6178231,20.35997692,0.252108283,8.899772817,1.7002118,
                ...
                -2.948,0.059,-0.03,0.044022402,20.02536,0,1,4.1263,0.9428,0.912,1,2.5,0.8,
                0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001,-4.5752, 0.942) # Picea abies in Germany

pCROB_prior[,11] <- c(0.05,400,26,0.33,2.5,0.25,0.25,0.45,0.45,0.020088308,2,1.1,0.5,0.3,150,0.0117,
                ...
                26,0,1,2.7801,0.9395,1.191,1,2.5,0.8,0,0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,
...
pCROBAS_Ritika[,1] <- c(2.487157e-01, 1.965803e+02, 2.237387e+01, 2.988688e-01, 3.859024e+00,
                        1.493986e+00, 2.893154e-01, 2.035189e-01, 2.111638e-01, 4.278695e-02,
                        1.906700e+00, 2.543086e-01, 3.998025e-01, 3.282843e-01, 2.440000e+02,
                        0.000000e+00, 8.550095e+02, 4.011241e-01, 8.000000e-01, 6.870000e-01,
                        4.000000e-01, 4.400000e-01, 4.700000e-01, 6.400000e-01, 8.400000e-01,
                        1.000000e+00, 1.000000e+00, 1.000000e+00, 1.400000e+00, 1.250000e+03,
                        1.000000e-02, 3.300000e+01, 3.000000e-02, 6.690000e-04, -2.653000e+00,
                        5.500000e-02, -3.000000e-02, 7.651800e-02, 2.000789e+01, 0.000000e+00,
                        0.000000e+00, 2.780100e+00, 9.395000e-01, 1.191000e+00, 1.000000e+00,
                        2.500000e+00, 8.000000e-01, 9.999000e+00, 6.600000e-01, 8.589668e+02,
                        -8.602025e+00, 6.967144e-02, 9.383065e-03, 1.672500e+00, 1.200000e-02,
                        5.000000e+01, 8.000000e-01, 2.000000e-01, 7.000000e-01, 7.000000e-01,
                        0.000000e+00, 1.000000e-03, -4.987000e+00, 8.760000e-01)

pCROBAS_Ritika[,2] <- c(1.503511e-01, 2.193787e+02, 2.011128e+01, 2.502107e-01, 9.961833e+00,
                        1.769126e+00, 2.143973e-01, 3.043674e-01, 2.257251e-01, 1.532754e-02,
                        1.927000e+00, 3.386255e-01, 3.520782e-01, 5.556673e-01, 3.729700e+02,
                        0.000000e+00, 1.037631e+03, 2.816741e-01, 7.000000e-01, 8.740000e-01,
                        1.000000e-01, 2.800000e-01, 3.800000e-01, 4.800000e-01, 5.800000e-01,
                        2.000000e+00, 2.000000e+00, 1.000000e+00, 1.400000e+00, 1.250000e+03,
                        1.000000e-02, 3.700000e+01, 3.000000e-02, 3.270000e-04, -2.948000e+00,
                        5.900000e-02, -3.000000e-02, 6.650000e-02, 2.002536e+01, 0.000000e+00,
                        0.000000e+00, 4.126300e+00, 9.428000e-01, 9.120000e-01,  1.000000e+00,
                        2.500000e+00, 8.000000e-01, 9.999000e+00, 6.000000e-01, 1.337095e+03,
                        -1.903101e+01, 9.677108e-02, 2.034222e-03, 1.503300e+00, 1.130000e-02,
                        5.000000e+01, 8.000000e-01, 2.000000e-01, 7.000000e-01, 7.000000e-01,
                        0.000000e+00, 1.000000e-03, -5.032000e+00, 9.920000e-01)

pCROBAS_Ritika[,3] <- c(1.521215e-01, 2.099628e+02, 4.564133e+01, 2.550850e-01, 1.042274e+00,
                        1.184712e+00, 2.029672e-01, 2.354125e-01, 2.396627e-01, 1.436453e-02,
                        1.947403e+00, 4.659152e-01, 5.160468e-01, 4.915013e-01, 1.011458e+02,
                        0.000000e+00, 1.064463e+03, 4.038076e-01, 8.000000e-01, 0.000000e+00,
                        3.500000e-01, 5.000000e-01, 6.400000e-01, 7.500000e-01, 9.400000e-01,
                        1.000000e+00, 1.000000e+00, 2.000000e+00, 1.400000e+00, 1.250000e+03,
                        1.000000e-02, 3.700000e+01, 3.000000e-02, 6.440000e-04, -3.324000e+00,
                        1.350000e-01, -3.000000e-02, 1.500000e-02, 4.056652e+01, 0.000000e+00,
                        0.000000e+00, 0.000000e+00, 1.100000e+00, 1.091000e+00, 1.000000e+00,
                        2.500000e+00, 8.000000e-01, 9.999000e+00, 4.600000e-01, 9.786513e+02,
                        -1.613494e+01, 8.928385e-02, 2.468708e-03, 3.000000e+00, 3.700000e-02,
                        5.000000e+01, 2.000000e-01, 5.000000e-02, 7.000000e-01, 7.000000e-01,
                        0.000000e+00, 1.000000e-03, -5.602000e+00, 1.298200e+00)

pCROB <- pCROBAS_Ritika
pPREL <- c(413.000000,0.450000,0.118000,3.000000,0.748018,13.233830,-3.965787,18.766960,
  -0.130473,0.034459,0.450828,0.500000,-0.364000,0.324463,0.874151,0.075601,
  0.541605,0.273584,1.200000,0.330000,4.970496,0.000000,0.000000, 200.000000,
  0.000000,0.000000,20.000000, -999.000000, -999.000000,-999.000000)
pPREL_fran_Cal = c(413.000000, 0.450000, 0.118000, 3.000000, 0.745700, 10.930000, -3.063000, 17.720000,
...
pPRELES_Ritika <- c(413.00000000, 0.45000000, 0.11800000, 3.00000000, 0.73294802,
                    10.50024367, -3.83437385, 19.94879584, -0.06877150, 0.04006564,
                    0.16031672, 2000.00000000, 0.40000000, 0.26335808, 0.89317426,
                    0.10069238, 0.98665598, 0.01073236, 1.20000000, 0.33000000,
                    3.62753555, 0.00000000, 0.00000000, 160.00000000, 0.00000000,
                    0.00000000, 20.00000000, -999.00000000, -999.00000000, -999.00000000)


####default ECM model parameters
parsECMmod <- c(0.14, 2, 1, 0.5, 2.66, -88.5198, 1.7194, 3.4139, 0.02788, 0.4239, -0.3023, -26.14)
names(parsECMmod) <- c("h_M","s_H","phi_M","ksi_M","gamma_M","int_CN","p_lat","p_st","p1_rhoMcalc","p2_rhoMcalc","p3_rhoMcalc","p4_rhoMcalc")
...
parsCN_alfar[1,3] <- 0.1678*2
parsCN_alfar[2,3] <- 0.03297
parsCN_alfar[1,4:11] <- 0.1678
parsCN_alfar[2,4:11] <- 0.03297
