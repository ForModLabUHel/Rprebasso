...
# inAclct_def <- rep(999,(dim(pCROB)[2]))  ###pisy,piab,birch, "fasy","pipi","eugl","rops","popu",'eugrur','piab(DE)','quil')
# inAclct_def[1:12] <- c(80,80,80,80,50,13,30,50,13,120,100,80)  ###pisy,piab,birch, "fasy","pipi","eugl","rops","popu",'eugrur','piab(DE)','quil')
...
litterSizeDef[1,] <- 7
litterSizeDef[1,1:12] <- c(10,10,5,10,10,7,7,7,7,10,7,10)
litterSizeDef[2,] <- 2
