###default parameters
speciesNam <- c("pisy","piab","beal","fasy","pipi","eugl","rops",'popu')
pCROB <- matrix(NA,43,8,dimnames = list(NULL,speciesNam))
...
pHcM <- matrix(NA,7,8,dimnames = list(NULL,speciesNam))
