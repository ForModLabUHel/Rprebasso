...
pCROB <- matrix(NA,44,9,dimnames = list(NULL,speciesNam))
...
pCROB[,4] <- c(0.051373436,237.3752612,70.02066135,0.260359518,0.995872355,2.440734706,
               ...
               -2.948,0.059,-0.03,0.035899753,20.00788979,0,0.962722532,0,1.1,1.091)
...
pCROB[,9] <- c(0.204117167,183.1185505,26.02424445,0.222587319,1.004187457,0.404366253,
               ...
               -3.324,0.135,-0.03,0.058115759,40.0468376,2.968459454,1.189177125,0.1149,1.1508,1.091) # Eucalyptus grandis x Eucalyptus urophylla
