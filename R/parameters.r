...
pCROB[,1] <- c(0.22406007,195.16571750,20.00788979,0.25003240,3.90739583,0.90777990,
               ...
               9.999,.66,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001)
pCROB[,2] <- c(1.585611e-01,1.833353e+02,2.002536e+01,2.503559e-01,9.728822e+00,1.764810e+00,
               ...
               9.999,.60,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001)
pCROB[,3] <- c(0.17815383,216.13110400, 40.56651551,0.31592870,0.96149996,1.43787917,
               ...
               9.999,.46,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001)
pCROB[,4] <- c(0.051373436,237.3752612,70.02066135,0.260359518,0.995872355,2.440734706,
               ...
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001)
...
pCROB[,8] <- c(0.0552574805543716,146.1815811,59.47661807,0.293587959,0.989521945,
               ...
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001) #Populus is based on a small dataset
...
pCROB[,9] <- c(0.204117167,183.1185505,26.02424445,0.222587319,1.004187457,0.404366253,
               ...
               0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001) # Eucalyptus grandis x Eucalyptus urophylla
...
pCROB[,10] <- c(0.10526535,193.6178231,20.35997692,0.252108283,8.899772817,1.7002118,
                ...
                0.0,0.0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001) # Picea abies in Germany
...
pCROB[,11] <- c(0.05,400,26,0.33,2.5,0.25,0.25,0.45,0.45,0.020088308,2,1.1,0.5,0.3,150,0.0117,
                ...
                26,0,1,2.7801,0.9395,1.191,1,2.5,0.8,0,0,-9999,-9999,-9999,-9999,1.6725,0.012,50,0.8,0.2,0.7,0.7,0.0,0.001) # Quercus ilex in Spain (Literature-based/guessed)
